<%@ page title="" language="C#" masterpagefile="~/GeneralManagerOperations.master" autoeventwireup="true" inherits="Utilitybillreport, App_Web_akdmykmr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>SPRINT EXPRESS PAID UTILITY BILL REPORT</title>
</asp:Content>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                SPRINT EXPRESS UTILITY BILL REPORT
                            </h2>
                        </div>
                        <div class="body">
