<%@ page title="" language="C#" masterpagefile="~/GeneralManagerOperations.master" autoeventwireup="true" inherits="financepartiallypaidreport, App_Web_akdmykmr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>SPRINT PARTIALLY PAID FINANCE REPORT</title>
</asp:Content>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <h2>
                                SPRINT PARTIALLY PAID FINANCE REPORT
                            </h2>
                        </div>
                        <div class="body">
